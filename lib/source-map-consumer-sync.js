  ...
  originalPositionFor(aArgs) {
    ...
    if (mapping) {
      ...
      if (mapping.generatedLine === needle.generatedLine) {
        ...
        if (origLine != null) {
          if (mapping.generatedColumn === needle.generatedColumn) {
            ...
            // IMPRECISE match:
            // 
            // Go and report accordingly, in a backwards compatible manner:
            // we add a `columnOffset` field to the mapping record, but DO NOT
            // change the line/column mapping info itself!
            return {
              source,
              line: origLine,
              column: origColumn,
