  ...
  originalPositionFor(aArgs) {
    ...
    if (mapping) {
      ...
      if (origLine != null) {
        ...
        const lineOffset = needle.generatedLine - mapping.generatedLine;
        const columnOffset = needle.generatedColumn - mapping.generatedColumn;
