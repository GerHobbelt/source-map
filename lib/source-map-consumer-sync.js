      ...
      if (mapping.generatedLine === needle.generatedLine &&
        ...
        if (bias === SourceMapConsumerSync.GREATEST_LOWER_BOUND &&
          ...
          if (origLine != null) {
            ...
            console.warn("Found LOWER BOUND", JSON.stringify({
              needle,
              mapping,
              lineOffset: needle.generatedLine - mapping.generatedLine,
              columnOffset: needle.generatedColumn - mapping.generatedColumn,
            }, null, 2));
        ...
        } else if (bias === SourceMapConsumerSync.LEAST_UPPER_BOUND &&
            mapping.generatedLine === needle.generatedLine &&
            needle.generatedColumn < mapping.generatedColumn
        ) {
          let origLine = util.getArg(mapping, "originalLine", null);
          ...
          if (origLine != null) {
            ...
            console.warn("Found UPPER BOUND", JSON.stringify({
              needle,
              mapping,
              lineOffset: needle.generatedLine - mapping.generatedLine,
              columnOffset: needle.generatedColumn - mapping.generatedColumn,
