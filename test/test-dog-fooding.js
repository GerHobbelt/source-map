...
exports["test eating our own dog food"] = async function(assert) {
  ...
  util.assertMapping(2, 9, "/wu/tang/gza.coffee", 1, 7, null, null, smc, assert, true);
  util.assertMapping(3, 0, "/wu/tang/gza.coffee", 2, 0, null, null, smc, assert, true);
  util.assertMapping(3, 9, "/wu/tang/gza.coffee", 2, 7, null, null, smc, assert, true);
  util.assertMapping(4, 0, "/wu/tang/gza.coffee", 3, 0, null, null, smc, assert, true);
  util.assertMapping(4, 9, "/wu/tang/gza.coffee", 3, 7, null, null, smc, assert, true);
  util.assertMapping(5, 0, "/wu/tang/gza.coffee", 4, 0, null, null, smc, assert, true);
  util.assertMapping(5, 9, "/wu/tang/gza.coffee", 4, 7, null, null, smc, assert, true);
  util.assertMapping(6, 0, "/wu/tang/gza.coffee", 5, 0, null, null, smc, assert, true);
  util.assertMapping(6, 9, "/wu/tang/gza.coffee", 5, 9, null, null, smc, assert, true);
  util.assertMapping(6, 13, "/wu/tang/gza.coffee", 5, 11, null, null, smc, assert, true);
  ...
  util.assertMapping(2, 9, "/wu/tang/gza.coffee", 1, 7, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(3, 0, "/wu/tang/gza.coffee", 2, 0, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(3, 9, "/wu/tang/gza.coffee", 2, 7, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(4, 0, "/wu/tang/gza.coffee", 3, 0, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(4, 9, "/wu/tang/gza.coffee", 3, 7, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(5, 0, "/wu/tang/gza.coffee", 4, 0, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(5, 9, "/wu/tang/gza.coffee", 4, 7, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(6, 0, "/wu/tang/gza.coffee", 5, 0, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
  util.assertMapping(6, 9, "/wu/tang/gza.coffee", 5, 9, null, SourceMapConsumer.LEAST_UPPER_BOUND, smc, assert, true);
