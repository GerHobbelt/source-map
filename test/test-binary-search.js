...
exports["test too high with lub bias"] = function(assert) {
  ...
  assert.equal(binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND), -1);
};
...
exports["test too low with lub bias"] = function(assert) {
  ...
  assert.equal(haystack[binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND)], 2);
};
...
exports["test fuzzy search with lub bias"] = function(assert) {
  ...
  assert.equal(haystack[binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND)], 20);
};
...
exports["test multiple matches"] = function(assert) {
  ...
  assert.equal(binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND), 3);
};
...
exports["test multiple matches at the beginning"] = function(assert) {
  ...
  assert.equal(binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND), 0);
};
...
exports["test fuzzy match with duplicates in the data at match point"] = function(assert) {
  ...
  assert.equal(binarySearch.search(needle, haystack, numberCompare, binarySearch.LEAST_UPPER_BOUND), 2);

  assert.equal(binarySearch.search(needle, haystack, numberCompare, binarySearch.GREATEST_LOWER_BOUND), 1);
};
